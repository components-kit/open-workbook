...
const HOST_METHODS_BY_CAPABILITY: Record<string, string[]> = Object.fromEntries([
  ...
  ["excel.sheet.freeze_panes", ["operation.execute_batch"]],
  ...
  ["excel.range.write_data_validation", ["operation.execute_batch"]],
  ["excel.range.write_conditional_formatting", ["operation.execute_batch"]],
  ["excel.range.clear_style_dimensions", ["operation.execute_batch"]],
  ["excel.range.clear_style_dimensions_many", ["operation.execute_batch"]],
  ...
  ["excel.range.reorder_columns", ["operation.execute_batch"]],
  ...
  ["excel.range.hide_columns", ["operation.execute_batch"]],
  ["excel.range.unhide_columns", ["operation.execute_batch"]],
...
const OPERATION_KINDS_BY_CAPABILITY: Record<string, string[]> = Object.fromEntries([
  ...
  ["excel.sheet.freeze_panes", ["sheet.freeze_panes"]],
  ...
  ["excel.range.write_data_validation", ["range.write_data_validation"]],
  ["excel.range.write_conditional_formatting", ["range.write_conditional_formatting"]],
  ["excel.range.clear_style_dimensions", ["range.clear_style_dimensions"]],
  ["excel.range.clear_style_dimensions_many", ["range.clear_style_dimensions_many"]],
  ...
  ["excel.range.reorder_columns", ["range.reorder_columns"]],
  ...
  ["excel.range.hide_columns", ["range.hide_columns"]],
  ["excel.range.unhide_columns", ["range.unhide_columns"]],
