...
const ACTION_ALIASES: Record<string, AgentIntentAction> = {
  ...
  clear_filter: "clear_table_filters",
  clear_filters: "clear_table_filters",
  remove_filter: "clear_table_filters",
  remove_filters: "clear_table_filters",
  reset_filter: "clear_table_filters",
  reset_filters: "clear_table_filters",
  clear_autofilter: "clear_table_filters",
  clear_auto_filter: "clear_table_filters",
  remove_autofilter: "clear_table_filters",
  remove_auto_filter: "clear_table_filters",
  reset_autofilter: "clear_table_filters",
  reset_auto_filter: "clear_table_filters",
  ...
  update_dropdown_options: "update_dropdown_options",
  edit_dropdown_options: "update_dropdown_options",
  add_dropdown_option: "update_dropdown_options",
  rename_dropdown_option: "update_dropdown_options",
  delete_dropdown_option: "update_dropdown_options",
  remove_dropdown_option: "update_dropdown_options",
