...
- For structural range edits, use `insert_rows`, `delete_rows`, `insert_columns`, `delete_columns`, `merge_range`, or `unmerge_range` with an explicit sheet/range, then apply the returned preview once.
