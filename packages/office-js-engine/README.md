...
```ts
import { DefaultOfficeJsEngineOptions, OfficeJsEngine } from "@component-kit/open-workbook-office-js-engine";
```

Most users should install `@component-kit/open-workbook`. This package is published for engine integration work and tests.
